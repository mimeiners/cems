...
value="
.param temp=27 vdd=1.2 per=1u vcm=vdd/2.0 voff=vcm vamp=0.5 freq=80
...
set wr_singlescale
set wr_vecnames
wrdata tb_ideal_dsm1.txt vo q p1 p2
.endc
"}
...
C {devices/title.sym} -650 -40 0 0 {name=l5 author="Mirco Meiners and Boris Murmann"}
